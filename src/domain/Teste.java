...
public class Teste {
	public static void main(String[] args) {
		...
		// criando clientes
		try {
			hostel.createCustomer("Miss.", "Maria Luiza", "Fernandes", "19/04/2000", "Av. Getúlio Vargas",
					"37165000", "Alfenas", "MG", "Brasil", "mrluiza.fernandes@gmail.com");
			...
			hostel.createCustomer("Miss.", "Luana de Jesus", "Carvalho", "11/12/2000",
					"Mariana Ambrosina dos Reis", "40168020", "Rio de Janeiro", "RJ", "Brasil", "luana@gmail.com");
